...
def main():
    ...
    for r in reminders:
        ...
        if r["days_left"] == 0:
            print(f"🎉 Birthday reminder: **{r['name']}** has a birthday TODAY{age_str}!")
        elif r["days_left"] == 1:
            print(f"🎈 Birthday reminder: **{r['name']}** has a birthday TOMORROW{age_str}!")
        elif r["days_left"] == 7:
            print(f"📅 Birthday reminder: **{r['name']}** has a birthday in ONE WEEK{age_str} ({r['date']})!")
